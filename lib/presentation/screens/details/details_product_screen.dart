...
class DetailsProductScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          _InformationProduct(size: size, product: product, colors: colors),
          Align(
          ...
          Positioned(
            bottom: 0,
            child: _ButtonBottomOrderProduct(size: size),
          )
        ],
      ),
    );
...
class _InformationProduct extends StatelessWidget {
  const _InformationProduct({
    required this.size,
...
class _ButtonBottomOrderProduct extends StatelessWidget {
  const _ButtonBottomOrderProduct({
    super.key,
    required this.size,
  });
...
class _AppBarImage extends StatelessWidget {
  ...
  const _AppBarImage(
      {required this.imgUrl, required this.categoryProduct});
